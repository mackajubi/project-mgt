...
@Component({
  ...
  templateUrl: './road-development.component.html',
  styleUrls: ['./road-development.component.scss'],
  animations: [
    trigger('fadeIn', [
      transition('* => *', [
...
export class RoadDevelopmentComponent implements OnInit, AfterViewInit, OnDestroy {
